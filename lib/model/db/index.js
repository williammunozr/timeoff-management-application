...
var db_name     = process.env.NODE_DB_NAME;
var db_username = process.env.NODE_DB_USERNAME;
var db_password = process.env.NODE_DB_PASSWORD;
var db_host     = process.env.NODE_DB_HOST;
var db_dialect  = process.env.NODE_DB_DIALECT;

console.log("Value of env: %s", env);
console.log('Database Name: %s', db_name);
